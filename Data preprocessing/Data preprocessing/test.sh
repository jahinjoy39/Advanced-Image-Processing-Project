...
# ---- Paths ----
INPUT_ROOT_DIR="/data/users1/afani1/datasets/rsnaIntracranialAneurysm/kaggle_evaluation/series"
OUTPUT_ROOT_DIR="/data/users3/gnagaboina1/AIP/Data/NIfTI_Converted_Series_test"
INPUT_LIST="/data/users3/gnagaboina1/AIP/Data/code/test.txt"
...
# ---- Run dcm2niix ----
dcm2niix -o "${FULL_OUTPUT_DIR}" -f "%s_%d" -z n "${FULL_INPUT_DIR}"
