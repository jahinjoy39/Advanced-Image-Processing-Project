...
DATA_DIR="/data/users3/gnagaboina1/AIP/Data/MRI-T2_nii"
LIST_FILE="/data/users3/gnagaboina1/AIP/Data/code/t2.txt"    # ← absolute path!
OUTPUT_DIR="/data/users3/gnagaboina1/AIP/Data/processed_data_t2"
...
raw="${OUTPUT_DIR}/01_raw/${BASE_ID}_T2w.nii.gz"
bet="${OUTPUT_DIR}/02_bet/${BASE_ID}_T2w_bet.nii.gz"
n4="${OUTPUT_DIR}/03_n4/${BASE_ID}_T2w_bet_n4.nii.gz"
