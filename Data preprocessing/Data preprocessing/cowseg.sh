...
#SBATCH --output=/data/users3/gnagaboina1/AIP/Data/processed_data_cowseg/logs/preproc_%A_%a.out
#SBATCH --error=/data/users3/gnagaboina1/AIP/Data/processed_data_cowseg/logs/preproc_%A_%a.err
...
DATA_DIR="/data/users3/gnagaboina1/AIP/Data/MRI-T1_Segmentations_raw"
LIST_FILE="/data/users3/gnagaboina1/AIP/Data/code/cowseg.txt"    # ← absolute path!
OUTPUT_DIR="/data/users3/gnagaboina1/AIP/Data/processed_data_cowseg"
...
raw="${OUTPUT_DIR}/01_raw/${BASE_ID}_T1w.nii.gz"
bet="${OUTPUT_DIR}/02_bet/${BASE_ID}_T1w_bet.nii.gz"
n4="${OUTPUT_DIR}/03_n4/${BASE_ID}_T1w_bet_n4.nii.gz"
