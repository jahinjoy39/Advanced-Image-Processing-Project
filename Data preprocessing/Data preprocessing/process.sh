...
#SBATCH --output=/data/users3/gnagaboina1/AIP/Data/processed_data_t2/logs/preproc_%A_%a.out
#SBATCH --error=/data/users3/gnagaboina1/AIP/Data/processed_data_t2/logs/preproc_%A_%a.err
...
DATA_DIR="/data/users1/afani1/DIP/NIfTI_Converted_Series/all/clearImages"
LIST_FILE="/data/users3/gnagaboina1/AIP/Data/code/process.txt"    # ← absolute path!
OUTPUT_DIR="/data/users3/gnagaboina1/AIP/Data/processed_data"
